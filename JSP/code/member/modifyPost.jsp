...
function checkPostClose(zipcode, address) {
	opener.mdfFrm.zipcode.value = zipcode;
	opener.mdfFrm.addr1.value = address;
	window.close();
	opener.mdfFrm.addr2.focus();
}
...
<body>
<form name="checkPostForm" method="post" action="modifyPost.jsp">
